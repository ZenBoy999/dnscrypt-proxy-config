#!/bin/sh
echo "Generating Forwarding Rule ..."
wget -qN https://github.com/felixonmars/dnsmasq-china-list/raw/master/accelerated-domains.china.conf
...
echo "Generating Blacklist IP ..."
wget -qN https://github.com/felixonmars/dnsmasq-china-list/raw/master/bogus-nxdomain.china.conf
...
echo "Generating Blacklist Domains ..."
...
wget -qN https://raw.githubusercontent.com/jedisct1/dnscrypt-proxy/master/dnscrypt-proxy/example-dnscrypt-proxy.toml
